export function AgentInput() {
  return (
    <div className="flex justify-center items-start w-full flex-1 pt-40">
      ...
      >
        <textarea
          placeholder="Chat with the IBSimple AI agent..."
          className="w-full bg-transparent text-white placeholder:text-gray-500 text-base outline-none resize-none min-h-[80px]"
          rows={3}
        />
